...
The configuration is split into several files. The idea is to load the ones you want from your init file.
...
- https://web-mode.org/
* Obsolete packages
Packages I no longer actively use. I don't know if the setup still works.
** init-lsp
